...
if __name__ == '__main__':
    ...
    first_data = get_data(series_ids[0:24], BLS_API_KEY, year)
    second_data = get_data(series_ids[24:], BLS_API_KEY, year)
    ...
    national_response = write_cache_file(
        first_data, second_data, series_ids, BLS_API_KEY, year)
